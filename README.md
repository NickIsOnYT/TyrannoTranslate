...
- Auto-translate via 4 APIs.
- Super-Importer so you can export translations and apply any lines that match to other files.
- Explanation of the various bracket commands of Tyrannoscript
