## ToDo for TyrannoTranslate:

- Add a SuperImporter feature (export the list of original and translations to an xml file and allow importing to fill in all the original texts that are matching (needs to match exactly, do not allow the words to fill if it's in the middle of a random sentence))
